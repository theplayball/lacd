...
export default function Footer() {
  return (
    <footer className="bg-[#274472] text-[#e2eaf2] text-sm pt-12 pb-6 mt-16">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-12">
      ...
      <div className="mt-12 border-t border-gray-50 pt-6 px-4 container mx-auto flex flex-col xl:flex-row items-center justify-between">
