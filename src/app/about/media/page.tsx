...
const mediaData = [
  {
    ...
    date: "May 2025",
    description: "Comprehensive coverage of MP Nada Boustani's visit to the United States, including her meetings with the Lebanese community in New England, Massachusetts, and Michigan. The tour was organized by LACD and featured various events and community engagements.",
    sources: [
      {
        name: "Tayyar.org",
